...
# Re-solving Movie / 09 from Classes Exercises
...
class Movie:
    ...
    def watch(self):
        if not self.watched:
            self.__watched_movies += 1  # with "self" it means the Instance
            # Movie.__watched_movies += 1  # with the class name it means attribute for the whole class
        self.watched = True
